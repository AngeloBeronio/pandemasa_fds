Public Class Menu_2_
    ...
    Private Sub Menu_2__Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupMenuGrid(itemMenu)
        LoadMenu(itemMenu, "Soft Bread", PictureBox1, NumericUpDown1, selectedProductId, selectedProductName, selectedPrice)
    ...
    Private Sub Menu_2__Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
    ...
    Private Sub Menu_2__FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
