Public Class Menu_3_
    ...
    Private Sub Menu_3__Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupMenuGrid(itemMenu)
        LoadMenu(itemMenu, "Pastries", PictureBox1, NumericUpDown1, selectedProductId, selectedProductName, selectedPrice)
