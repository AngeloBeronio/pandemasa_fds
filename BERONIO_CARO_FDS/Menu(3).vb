...
Public Class Menu_3_
	...
	' FORM LOAD
	'==================================================
	Private Sub Menu_3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    '==================================================
    ' LOAD HOUSE SPECIALS FROM DATABASE
    '==================================================
    Private Sub LoadHouseSpecials()
        ...
        Try
            ...
            "SELECT p.product_id, p.product_name, p.selling_price, p.status, p.image_path
             ...
             WHERE c.category_name = 'Pastries'
            ...
            ' ── Auto select Spanish Bread Original on load ──
