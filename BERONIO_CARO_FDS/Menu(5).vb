...
Public Class Menu_5_

    Private selectedProductId As Integer = -1
    Private selectedProductName As String = ""
    Private selectedPrice As Decimal = 0

    Private Sub Menu_5__Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupMenuGrid(itemMenu)
        LoadMenu(itemMenu, "Drinks", PictureBox1, NumericUpDown1, selectedProductId, selectedProductName, selectedPrice)
	...
	Private Sub Menu_5__Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
    ...
    Private Sub Menu_5__FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
