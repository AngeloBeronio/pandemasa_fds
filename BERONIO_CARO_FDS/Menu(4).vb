...
Public Class Menu_4_

    Private selectedProductId As Integer = -1
    Private selectedProductName As String = ""
    Private selectedPrice As Decimal = 0

    Private Sub Menu_4__Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupMenuGrid(itemMenu)
        LoadMenu(itemMenu, "Cakes & Sweet Baked Goods", PictureBox1, NumericUpDown1, selectedProductId, selectedProductName, selectedPrice)
    ...
    Private Sub Menu_4__Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
    ...
    Private Sub Menu_4__FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
